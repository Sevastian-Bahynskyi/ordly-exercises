...
3. Parse the available learning signals, including word/phrase identity, learning status, review history, practice history, recall/stability information, due state, memory tier and timestamps when present.
4. Prioritise:
